...
var typed=new Typed('#typewriter_text',{
    strings:[namaste,welcome,love_line2,love_line,ask_vitian,redir],
    typeSpeed:30,
    backSpeed:70,
    loop:true
});